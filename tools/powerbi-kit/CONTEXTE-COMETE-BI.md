...
- Depuis le 8 septembre, Claude travaille dans un worktree git dédié (`~/GitHub/comete-ds-powerbi-kit`, branche powerbi-kit) pour ne plus entrer en collision avec le checkout principal où Axel change de branche et stashe en direct. Les thèmes générés s'appellent « Comète BI clair » et « Comète BI sombre ».
