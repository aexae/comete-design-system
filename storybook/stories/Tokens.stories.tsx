...
const S = {
  page: { display: "flex", fontFamily: "var(--font-family-primary, system-ui, sans-serif)", fontSize: 13, color: "var(--text-default)", minHeight: "100%", background: "var(--background-surface-default)" } satisfies CSSProperties,
  sidebar: { position: "sticky" as const, top: 0, alignSelf: "flex-start", width: 220, flexShrink: 0, padding: "24px 0 24px 24px", borderRight: "1px solid var(--border-default)", maxHeight: "100vh", overflowY: "auto" as const } satisfies CSSProperties,
